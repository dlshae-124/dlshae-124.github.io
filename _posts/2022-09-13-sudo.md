...
&nbsp;&nbsp;&nbsp;&nbsp;`추가할 사용자명  ALL=(ALL)    ALL` 입력
  ...
  ``` 는 <br/> sudo 권한을 부여할 사용자 명 추가]![image](https://user-images.githubusercontent.com/111679538/188355440-04efee74-7fc2-4dd5-bc1a-d355a5b9aa54.png "sudoers에 user1 추가")
